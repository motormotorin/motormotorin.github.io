...
import LayersSidebar from './controllers/LayersSidebar';


import Message from './controllers/Message';
import MapObjects from './models/MapObjects';
// import MapData from './models/MapData';
// import FooterToolbar from './controllers/FooterToolbar';
...
function App() {
    ...
    this.map = new Map();
    this.layersSidebar = new LayersSidebar();
    this.message = new Message();
    this.mapObjects = new MapObjects();

    this.mapObjects.loadPlacesLayers().then((data) => {
        // console.log(data);
    });
